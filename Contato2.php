...
<html>
    <head>
        <title>Semprebom Tecnologia</title>
        <meta charset="utf-8">
        <!-- Meta -->
        <meta name="keywords" content="" />
        <meta name="author" content="matheus" >
        <!-- <meta name="robots" content="" /> -->
        <meta name="description" content="Semprebomtecnologia" />
        ...
        <link rel="stylesheet" href="js/form/sky-forms.css" type="text/css" media="all">
		  ...
		  <script type="text/javascript" src="/mibew/js/compiled/chat_popup.js"></script>
 		  <script type="text/javascript">Mibew.ChatPopup.init({"id":"597dc4f1d940a7c3","url":"http://www.semprebomtecnologia.com.br/mibew\/index.php\/chat?locale=pt-br","preferIFrame":true,
 	"modSecurity":false,"width":640,"height":480,"resizable":true,"styleLoader":"http://www.semprebomtecnologia.com.br/mibew\/index.php\/chat\/style\/popup"});</script>
	...
	<body>
		...
		<script type="text/javascript" src="js/Toggle-Menu/menu.js"></script>
