 ...
 * limitations under the License.
 */
function(e,s){var n=new s.Marionette.Application;n.addRegions({messagesRegion:"#messages-region"}),n.addInitializer(function(s){var i=new e.Collections.Messages;e.Objects.Collections.messages=i,i.updateMessages(s.messages),n.messagesRegion.show(new e.Views.MessagesCollection({collection:i}))}),e.Application=n}(Mibew,Backbone);